...
Flet 桌面程序，提供中国市场指数、基金列表与基金详情，支持自动刷新、持仓盈亏和基金净值图表。
...
- 也支持更简写的配置：
   ...
   ```
- 运行时会自动读取该文件并在下拉菜单中加入对应基金，优先展示盘中估值；上游未提供盘中估值时，明确降级为最新已公布净值。详情页还展示近3/7/15/30 日累计涨跌，以及 MA5/MA10/MA20/MA250。
...
说明：
- “基金列表”页以“估 / 净 / 待”区分盘中估值、已公布净值和暂无报价，并展示基金名称、当日估值涨跌幅、上一交易日涨跌幅、持仓份额、持仓成本、当日盈亏、累计盈亏；“实时估值”和“净值变化”支持上/下三角按钮升序、降序排序。
- “基金列表”页右上角支持“+”添加：输入基金代码回车后可预览基金，点击“添加到列表”会写入 `funds.json` 并立即刷新列表。
- “基金列表”页每只基金支持“录入持仓 / 编辑持仓”，保存后会按盘中估值或已公布净值与前一净值计算当日盈亏，并按当前市值与持仓成本计算累计盈亏。
